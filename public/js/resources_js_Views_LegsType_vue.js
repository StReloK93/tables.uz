...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  methods: {
    ...
    setLegType: function setLegType(typeIndex) {
      this.$store.state.params.legType = typeIndex;
    },
...
var _hoisted_37 = {
  key: 0,
  "class": "w-full h-full bg-white border shadow-md border-gray-300"
};
var _hoisted_38 = {
  key: 1,
  "class": "w-full h-full bg-gray-400 border shadow-md border-gray-300"
};
var _hoisted_39 = {
  key: 2,
  "class": "w-full h-full bg-black border shadow-md border-gray-300"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* CLASS */
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", {
      ...
      "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)([{
        colorActive: _ctx.$store.state.params.legColor == n
      }, "p-1 rounded-md h-36"])
