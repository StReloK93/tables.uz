...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    scene.onReadyObservable.add(function () {
      ...
      _this.assignTextures(store.state.params.legType);
    });
  },
  methods: {
    ...
    assignTextures: function assignTextures(legtype) {
      var _this3 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var _yield$store$dispatch, folders, Arrays;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this3.deskMaterials = 0;
                _context.next = 3;
                return store.dispatch('deskTextures');

              case 3:
                _yield$store$dispatch = _context.sent;
                folders = _yield$store$dispatch.folders;
                _this3.deskMaterials = folders;
                Arrays = [['desks/bamboo', 'desks/solidedge'], [], ['desks/bamboo', 'desks/solidedge', 'desks/pyledge'], ['desks/bamboo', 'desks/solidedge'], ['desks/bamboo', 'desks/solidedge']];
                Arrays[legtype - 1].forEach(function (folder) {
                  var conut = null;

                  _this3.deskMaterials.find(function (texture, index) {
                    if (texture.path == folder) {
                      conut = index;
                    }
                  });

                  _this3.deskMaterials.splice(conut, 1);
                });
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("section", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("main", null, [_hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.$store.state.legTypes, function (legs, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("aside", {
      ...
      onClick: function onClick($event) {
        return $data.events.setLegType(index + 1, $options.deskFolder, $data.events.setDeskMaterial, $options.assignTextures);
      },
