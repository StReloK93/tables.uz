    ...
    <section>
        ...
        <main class="flex -mr-2 text-center justify-center">
            <aside class="mr-2 w-1/3">
                <div @click="events.setPart(1)" :class="{'border-myblue': $store.state.custom.partition == 1}" class="h-full py-2 border border-transparent rounded-md relative">
            ...
            <aside class="mr-2 w-1/3">
                <div @click="events.setPart(2)" :class="{'border-myblue': $store.state.custom.partition == 2}" class="h-full py-2 border border-transparent rounded-md relative">
