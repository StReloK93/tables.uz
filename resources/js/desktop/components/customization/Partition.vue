    ...
    <section>
        ...
        <main class="flex -mx-2 text-center pb-10">
            <aside class="px-2 w-1/3">
                <div @click="setPart(1)" :class="{'border-myblue': $store.state.custom.partition == 1}" class="cursor-pointer py-4 border border-transparent rounded-md relative">
            ...
            <aside class="px-2 w-1/3">
                <div @click="setPart(2)" :class="{'border-myblue': $store.state.custom.partition == 2}" class="cursor-pointer py-4 border border-transparent rounded-md relative">
