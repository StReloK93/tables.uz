         ...
         <div class="flex flex-wrap -mx-3">
            <aside v-for="n in 3" :key="n" class="w-1/5 px-3">
               <main  @click="setLegColor(n)" :class="{colorActive: $store.state.params.legColor == n}" class="p-1 rounded-md h-36">
                   <div v-if="n == 1" class="w-full h-full bg-white border shadow-md border-gray-300"></div>
                   <div v-if="n == 2" class="w-full h-full bg-gray-400 border shadow-md border-gray-300"></div>
                   <div v-if="n == 3" class="w-full h-full bg-black border shadow-md border-gray-300"></div>
               </main>
            </aside>
         </div>
      </main>
